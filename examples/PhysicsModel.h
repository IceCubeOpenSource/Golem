...
public:
    ...
    struct UncertaintyWeighter {
        ...
        ///this function is also given the event itself, frm which it could get
    ...
    HistogramSet MakeHistogramSet() const {
        ...
        //runtime. 
        LogarithmicAxis energy_axis(0,0.1); //ten bins per decade, based at 10^0
        LinearAxis cos_zenith_axis(0,0.1); //bin with a width of 0.1, based at 0
    ...
    ///we want to. 
    WeighterMaker MakeWeigherMaker(const ParameterSet& params) {
